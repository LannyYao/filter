...
/**
 * @author Lanny Yao
 * @date 3/23/2019 5:39 PM
 */
@Slf4j
@WebFilter(urlPatterns = "/api/once/*", filterName = "firstOnceFilter")
public class FirstOnceFilter extends OncePerRequestFilter {
